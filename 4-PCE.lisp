...
;;; Copyright   : (c) 2012-6 Frank Tamborello
...
;;;		To load, place in your ACT-R user-loads folder, ensuring numeral
;;; 		prepends to filenames so that they load in this order: 
;;;		misc-lib.lisp, virtual-experiment-window.lisp, boost.lisp, PCE.lisp.
;;;		Your Lisp compiler may print some warnings the first time you load 
;;; 		these files, but the model should execute regardless.
;;; 
;;; Bugs        : 
;;;
;;; To do       : 		
...
;; placeholder
(defmethod finish-experiment (st-exp-window)
  (declare (ignore st-exp-window))
  nil)
